...
\begin{itemize}
\item Goal rewarding encoding: define a state where the goal is achieved as   having $+1$ reward and all other states yield zero reward.
\item Action penalty representation: penalize the agent with a $-1$ each step in which the goal has not been achieved.
\end{itemize}
...
\subsection{The reward hypothesis} There are three ways to think about creating intelligent behavior.
\begin{itemize}
